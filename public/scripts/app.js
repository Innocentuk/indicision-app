...
var IndecisionApp = function (_React$Component) {
  ...
  _createClass(IndecisionApp, [{
    ...
    value: function handlePick() {
      var randomOptions = Math.floor(Math.random() * this.state.options.length);
      var option = this.state.options[randomOptions];
      alert(option);
      /*     this.setState(state => {
    ...
    value: function render() {
      var subtitle = "Let computer decide for you.";
...
var AddOption = function (_React$Component2) {
  ...
  _createClass(AddOption, [{
    ...
    value: function handleAddOption(e) {
      ...
      var option = e.target.elements.option.value.trim(); // trim() removes empty spaces
